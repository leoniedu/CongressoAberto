...
content <- "
<p> <a href=\"http://CongressoAberto.com.br\"> CongressoAberto.com.br </a>  é um site independente que visa aumentar a transparência e contribuir para debates acerca do legislativo brasileiro, facilitando o acesso a informação e análise sobre o tema. <a href=\"http://CongressoAberto.com.br\"> CongressoAberto.com.br </a> utiliza informações oficiais providas pelo Congresso e outras órgãos do governo para gerar um panorama completo da atuação de parlamentares e partidos, utilizando para isso conceitos e métodos da ciência política moderna. </p>
