...
content <- '<table>
                <tr>
                <td><img width=400 src="/images/camara/rcbyweek.png" alt="Número de votações por mês" /></td><td><explain><p>Os pontos no gráfico à esquerda mostram o número dias com votações por mês, que pode ser considerado como um bom indicador do nível de atividade na Câmara.  As linhas mostram a tendência dos dados,  e auxiliam na visualização. A legislatura atual está em vermelho. Observe que nas legislaturas mais recentes o nível de atividade é bastante reduzido no período eleitoral.</p>
...
</td><td><img width=400 src="/images/camara/cumulativerc.png" alt="Número de votações acumuladas" /> 
</tr>
</table>'
