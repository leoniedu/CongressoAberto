...
* DONE tweet about the new deps page.
* DONE Fix manuela davila
Note: might create problems down the line
* DONE Put values on the legislator stats (number and prop of votes)
* DONE Format values in legislator stats
* TODO link do partido do cara (na pagina dos deputados) para a pagina do partido (quando houver?)
* DONE nome do cara na primeira linha dos dados
